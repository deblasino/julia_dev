...
const OBSTACLE_POSITION_2 = SVector(0.4, -0.1, 0.2)
const OBSTACLE_POSITION_3 = SVector(0.45, 0.0, 0.4)
const OBSTACLE_POSITION_4 = SVector(0.55, -0.15, 0.2)
const OBSTACLES_LIST = [OBSTACLE_POSITION_1, OBSTACLE_POSITION_2, OBSTACLE_POSITION_3, OBSTACLE_POSITION_4]
...
ostacoli_vm = ["ObstaclePosition1", "ObstaclePosition2", "ObstaclePosition3", "ObstaclePosition4"]
...
ostacoli_robot_cfg = [(id=1, c=".virtual_mechanism.ObstaclePosition1"), (id=2, c=".virtual_mechanism.ObstaclePosition2"), (id=3, c=".virtual_mechanism.ObstaclePosition3"), (id=4, c=".virtual_mechanism.ObstaclePosition4")]
