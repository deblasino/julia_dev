...
#  Identifichiamo il frame dell'ultimo segmento generato

last_seg_frame_name = "seg$(NUM_ACTUAL_SEGMENTS)_frame"

# Definiamo la coordinata della posizione attuale della punta
add_coordinate!(vm, FrameOrigin(last_seg_frame_name); id="Snake_Tip_Pos")

# Definiamo il punto di ancoraggio fisso
...
#  Calcoliamo l'errore (distanza tra punta attuale e ancoraggio)
...
#  Applichiamo una Molla "Rigida" e uno Smorzatore
