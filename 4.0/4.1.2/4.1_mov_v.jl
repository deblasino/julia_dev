...
# =======================================================================================
# --- 1.5 GENERAZIONE TOPOLOGIA TRAMITE SIMULAZIONE FISICA (TELESCOPICA) ---
# =======================================================================================
println("1.5. Generazione Topologia tramite Simulazione Fisica (Telescopica - Asse Z)...")

# --- A. Calcolo Target Iniziale (Invariato) ---
...
for i in 1:NUM_SEGMENTS_DESIRED
    ...
    # 3. GIUNTO PRISMATICO (MODIFICATO: Estensione Lungo Z positivo)
