...
const OBSTACLE_POSITION_2 = SVector(0.3, -0.1, 0.4)
const OBSTACLE_POSITION_3 = SVector(0.5, 0.0, 0.4)
...
for i in 1:NUM_SEGMENTS_DESIRED
    ...
    prob = get_ode_problem(cache, VMRobotControl.DEFAULT_GRAVITY, q_start, zero_q̇(m_step), (0.0, 3.0))
