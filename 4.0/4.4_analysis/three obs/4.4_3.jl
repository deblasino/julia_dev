...
while !reached_target && num_generated_segments < MAX_SEGMENTS
    ...
    prob = get_ode_problem(cache, VMRobotControl.DEFAULT_GRAVITY, q_start, zero_q̇(m_step), (0.0, 10.0))
...
is_completed = false
completion_threshold = 0.10 # 5 cm di tolleranza per considerare il target raggiunto
